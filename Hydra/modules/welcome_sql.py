...
from Hydra.modules.helper_funcs.msg_types import Types
...
DEFAULT_WELCOME_MESSAGES = [
    ...
    "Ready player {first}",
    "A Powerful person appeared.",
    "{first} came in like a Lion!",
    "{first} has joined Our Kingdom.",
    "Hey {first} are You See The Sea? , if You don't See This chat Like Sea So long😂🔥 ",
    "{first} just joined the chat!",
    "{first} just joined. Everyone, look busy!",
    "Welcome, {first}. Here Is awasome Bots + Legends 😂.",
    "Welcome, {first}. Can You Buy pizza for me?",
    "Welcome, {first}. We hope you brought pizza.",
    "Welcome, {first}. Leave your weapons by the door.",
    "{first}. Welcome To The Kingdom.",
    "Legend appeared.",
    "Wow {first}. Joined Our Group, can we go to party",
    "Are You Fine?",
    " {first}. Do you know my master?",
    "Hey {first}. Do you play minecraft?",
]
DEFAULT_GOODBYE_MESSAGES = [
    "{first} Why Left In The Kingdom.",
    "{first}. Thanks for left in our group ",
    "Don't Forget Him {first}.",
    "Oh No Legend left.",
...
class GoodbyeButtons(BASE):
    ...
    def __init__(self, chat_id, name, url, same_line=False):
        ...
        self.url = url
        self.same_line = same_line
# Hey If you find error Contact @FutureCity005
