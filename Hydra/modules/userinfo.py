...
import Hydra.modules.sql.userinfo_sql as sql
from Hydra import (
    DEMONS,
    DEV_USERS,
    DRAGONS,
...
from Hydra.__main__ import STATS, TOKEN, USER_INFO
from Hydra.modules.disable import DisableAbleCommandHandler
from Hydra.modules.helper_funcs.chat_status import sudo_plus
from Hydra.modules.helper_funcs.extraction import extract_user
from Hydra.modules.sql.afk_sql import check_afk_status, is_afk
...
def info(update: Update, context: CallbackContext):
    ...
    buttons = [
        [
            InlineKeyboardButton(text="Health", url="https://t.me/updates004/7"),
            InlineKeyboardButton(text="Disasters", url="https://t.me/updates004/8"),
        ],
    ]
...
def stats(update, context):
    ...
    try:
        update.effective_message.reply_photo(
            ...
            + f"\n\n[ Support ](https://t.me/FutureCity005) | [𓆩𝗧ᴏᴏɴ 𝗟ɪɴᴋᴢ𓆪](https://t.me/Toon_LinkZ)\n\n"
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            text="Repo", url="github.com/Otazuki004/HydraV5TL"
                        )
                    ]
                ]
            ),
        ...
        update.effective_message.reply_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            text="Repo", url="github.com/Otazuki004/HydraV-5TL"
                        )
                    ]
                ]
            ),
